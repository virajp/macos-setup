set --export POSH_THEME '/Users/virajpatel/.config/oh-my-posh.yaml'
set --export POSH_SHELL fish
set --export POSH_SHELL_VERSION $FISH_VERSION
set --export POWERLINE_COMMAND oh-my-posh
set --export POSH_SESSION_ID '7a4cc4a7-d84b-4de2-9346-3678b4211ddc'
...
set --global _omp_executable '/opt/homebrew/bin/oh-my-posh'
