...
Example: `/oh-my-claudecode:release 2.4.0` or `/oh-my-claudecode:release patch`
or `/oh-my-claudecode:release minor`
...
- `.claude-plugin/marketplace.json` (both `plugins[0].version` and root
  `version`)
