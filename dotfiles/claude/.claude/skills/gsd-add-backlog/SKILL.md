...
4. **Add to ROADMAP.md** under a `## Backlog` section. If the section doesn't
   exist, create it at the end:
   ...
   **Goal:** [Captured for future planning] **Requirements:** TBD **Plans:** 0
   plans
