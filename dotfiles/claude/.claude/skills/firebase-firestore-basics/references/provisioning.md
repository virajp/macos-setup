...
`firebase init`, as it expects interactive inputs.
...
This will use the default database. To use a different database, specify the
database ID and location. You can check the list of available databases using
`firebase firestore:databases:list`. If the database does not exist, it will be
