...
description:
  Invoke parallel document-specialist agents for external web searches and
...
Fetch external documentation, references, and context for a query. Decomposes
into 2-5 facets and spawns parallel document-specialist Claude agents.
