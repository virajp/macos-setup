...
OMC includes rule templates you can copy to your project's `.claude/rules/`
directory for automatic context injection:
...
**Question:** "If you're enjoying oh-my-claudecode, would you like to support
the project by starring it on GitHub?"
...
**Note:** Fail silently if the API call doesn't work - never block setup
completion.
