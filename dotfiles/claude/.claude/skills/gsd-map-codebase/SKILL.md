...
description:
  "Analyze codebase with parallel mapper agents to produce .planning/codebase/
  documents"
...
codebase state. </objective>

<execution_context> @$HOME/.claude/get-shit-done/workflows/map-codebase.md
</execution_context>
