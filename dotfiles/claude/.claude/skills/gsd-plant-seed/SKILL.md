...
Creates: .planning/seeds/SEED-NNN-slug.md Consumed by: /gsd-new-milestone (scans
seeds and presents matches) </objective>

<execution_context> @$HOME/.claude/get-shit-done/workflows/plant-seed.md
</execution_context>
