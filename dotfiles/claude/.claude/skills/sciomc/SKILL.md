...
name: sciomc
description:
  Orchestrate parallel scientist agents for comprehensive analysis with AUTO
  mode
...
Orchestrate parallel scientist agents for comprehensive research workflows with
optional AUTO mode for fully autonomous execution.

## Overview

Research is a multi-stage workflow that decomposes complex research goals into
...
![Figure 1: Description](figures/figure-1.png) _Caption: Description of what the
figure shows_

![Figure 2: Description](figures/figure-2.png) _Caption: Description of what the
figure shows_
```
