...
description:
  "Architects a Flutter application using the recommended layered approach (UI,
  Logic, Data). Use when structuring a new project or refactoring for
  scalability."
metadata:
...
### 2. Logic Layer (Domain) - _Conditional_
...
- [ ] **Step 6: Run Validator.** Execute unit tests for Services, Repositories,
  ...
  - _Feedback Loop:_ Review test failures -> Fix logic/mocking errors -> Re-run
    tests until passing.
