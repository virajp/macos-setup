...
Creates comprehensive, hierarchical AGENTS.md documentation across the entire
codebase.

## Core Concept

AGENTS.md files serve as **AI-readable documentation** that helps agents
understand:
...
**IMPORTANT**: Generate parent levels before child levels to ensure parent
