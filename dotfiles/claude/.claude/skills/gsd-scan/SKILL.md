...
Lightweight alternative to `/gsd-map-codebase` — spawns one mapper agent instead
of four parallel ones. </objective>

<execution_context> @$HOME/.claude/get-shit-done/workflows/scan.md
</execution_context>
